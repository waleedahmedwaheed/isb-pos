...
<table class="table dt-table" >
									...
									<tbody>
									<?php	
							$selectSQL = "select * from production_prod where pp_status = 0 and pro_id = '".$_GET["pro_id"]."' ORDER BY pp_id desc";
	...
	<a href="#" class="delete_class<?php echo $id; ?> btn btn-danger btn-xs" id="confirm<?php echo $id; ?>" value="<?php echo $id; ?>"  title="Delete" ><i class = "fa fa-trash-o"></i> Delete</a>
                ...
                del_id = $(this).attr('value');							
                    ...
                    callback: function ($this, type) {
                        if (type === 'yes') {
						               ...
						               $.ajax({
                url: "delete.php?id=10&pp_id="+ del_id,
                cache: false,
                success:function(result){
                    ...
                    tr.fadeOut(1000, function(){
						...
						window.location="pro_products.php?pro_id=<?php echo $pro_id_; ?>";
                    });
                }
            });
