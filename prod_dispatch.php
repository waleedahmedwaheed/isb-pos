					...
					<div class="col-md-12">
						<div class="box-widget widget-module">
							<div class="widget-head clearfix">
								...
								<h4>Production Dispatch (Cat Processed)</h4>
							</div>
							<div class="widget-container">
								<div class=" widget-block">
								  ...
								  <?php	
							$selectSQL = "select * from prod_processed where s_shop_id = '".$_SESSION['s_id']."' ORDER BY ppr_id desc";
							mysql_select_db($database_dbconfig, $dbconfig);
							...
							while($row1 = mysql_fetch_assoc($Result1))
							{
								...
								<?php if($ppr_status_==1) {
									echo '<label class="label label-success">Sent from shop</label>';
...
//$("#loader").show();
$.ajax({
url: "add_pro_approved.php", // Url to which the request is send
type: "POST",             // Type of request to be send, called as method
data: new FormData(this), // Data sent to server, a set of key/value pairs (i.e. form fields and values)
contentType: false,       // The content type used when sending data to the server.
cache: false,             // To unable request pages to be cached
...
window.location='prod_dispatch.php';
}
});
...
//$("#loader").show();
$.ajax({
url: "add_pro_loss.php", // Url to which the request is send
type: "POST",             // Type of request to be send, called as method
data: new FormData(this), // Data sent to server, a set of key/value pairs (i.e. form fields and values)
contentType: false,       // The content type used when sending data to the server.
cache: false,             // To unable request pages to be cached
