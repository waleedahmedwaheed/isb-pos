...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 01, 2017 at 05:43 PM
...
WHERE NOT EXISTS (select ppr_id from stock s where s.ppr_id=pprid and s.shop_id = pp.s_shop_id and s.prod_id = p.prod_id and s.st_inout = 0)
 and p.ppr_id = pprid and pp.ppr_status = 3 and p.ppr_id = pp.ppr_id$$
...
INSERT INTO `farm` (`farm_id`, `farm_name`, `farm_rate`, `mandi_rate`, `pur_date`, `shop_id`) VALUES
(1, 'farm name', 102, 125.5, '2017-07-12', 2),
(2, 'farm name', 100, 125.5, '2017-07-20', 2),
(3, 'farm name', 100, 125.5, '2017-07-06', 0),
(4, 'farm name', 100, 125.5, '2017-07-06', 0),
(5, 'farm name', 100, 125.5, '2017-07-06', 2),
(6, 'farm name', 100, 125.5, '0000-00-00', 2),
(7, 'farm name', 100, 125.5, '0000-00-00', 2),
(8, 'farm name', 100, 125.5, '0000-00-00', 2),
(9, 'farm name', 100, 125.5, '0000-00-00', 2),
(10, 'farm name', 100, 125.5, '0000-00-00', 2),
(11, 'farm name', 100, 125.5, '0000-00-00', 2),
(12, 'farm name', 100, 125.5, '0000-00-00', 2),
(13, 'farm name', 100, 125.5, '1970-01-01', 2),
(14, 'farm name', 100, 125.5, '2017-06-30', 2),
(15, 'farm name', 100, 125.5, '2017-07-14', 2);
...
(4, 'user', 'a1Bz20ydqelm8m1wql21232f297a57a5a743894a0e4a801fc3', 'Waleed Ahmed', 0, 2),
(6, 'admin', 'a1Bz20ydqelm8m1wql202cb962ac59075b964b07152d234b70', 'IC ADMIN', 0, 0),
...
(14, 'wal', 'a1Bz20ydqelm8m1wql827ccb0eea8a706c4c34a16891f84e7b', 'wal', 0, 3),
...
ALTER TABLE `cust_factor`
  ...
  ADD CONSTRAINT `FK_cust_factor_product` FOREIGN KEY (`prod_id`) REFERENCES `product` (`prod_id`) ON UPDATE CASCADE;
